...
- [nextcloud/android](https://github.com/nextcloud/android) ([stable-3.16.0](https://github.com/nextcloud/android/releases/tag/stable-3.16.0), 3 days ago) - 📱 Nextcloud Android app
- [nextcloud/android-library](https://github.com/nextcloud/android-library) ([2.6.0](https://github.com/nextcloud/android-library/releases/tag/2.6.0), 3 days ago) - ☎️ Nextcloud Android library
...
- [icewind1991/SMB](https://github.com/icewind1991/SMB) ([v3.4.1](https://github.com/icewind1991/SMB/releases/tag/v3.4.1), 2 weeks ago) - PHP wrapper for smbclient
- [nextcloud/guests](https://github.com/nextcloud/guests) ([v2.0.0](https://github.com/nextcloud/guests/releases/tag/v2.0.0), 3 weeks ago) - 🙈 Create guest users which can only see files shared with them
- [nextcloud/server](https://github.com/nextcloud/server) ([v21.0.1](https://github.com/nextcloud/server/releases/tag/v21.0.1), 4 weeks ago) - ☁️ Nextcloud server, a safe home for all your data
