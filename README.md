...
- [nextcloud/guests](https://github.com/nextcloud/guests) ([v1.6.2](https://github.com/nextcloud/guests/releases/tag/v1.6.2), today) - 🙈 Create guest users which can only see files shared with them
- [nextcloud/news](https://github.com/nextcloud/news) ([15.1.1-rc1](https://github.com/nextcloud/news/releases/tag/15.1.1-rc1), 5 days ago) - :newspaper: RSS/Atom feed reader
- [nextcloud/server](https://github.com/nextcloud/server) ([v20.0.4](https://github.com/nextcloud/server/releases/tag/v20.0.4), 5 days ago) - ☁️ Nextcloud server, a safe home for all your data
- [nextcloud/desktop](https://github.com/nextcloud/desktop) ([v3.1.0](https://github.com/nextcloud/desktop/releases/tag/v3.1.0), 1 week ago) - 💻 Desktop sync client for Nextcloud
