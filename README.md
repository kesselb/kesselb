...
- [nextcloud/text](https://github.com/nextcloud/text) - 📑 Collaborative document editing using Markdown (4 days ago)
...
- [nextcloud/spreed](https://github.com/nextcloud/spreed) ([v10.0.0-rc.2](https://github.com/nextcloud/spreed/releases/tag/v10.0.0-rc.2), 1 day ago) - 📞😀 Nextcloud Talk – chat, video &amp; audio calls for Nextcloud
- [nextcloud/desktop](https://github.com/nextcloud/desktop) ([v3.0.2](https://github.com/nextcloud/desktop/releases/tag/v3.0.2), 1 day ago) - 💻 Desktop sync client for Nextcloud
- [alexdebril/feed-io](https://github.com/alexdebril/feed-io) ([v4.7.9](https://github.com/alexdebril/feed-io/releases/tag/v4.7.9), 4 days ago) - A PHP library to read and write feeds in JSONFeed, RSS or Atom format
