...
- [nextcloud/news](https://github.com/nextcloud/news) ([15.0.6](https://github.com/nextcloud/news/releases/tag/15.0.6), 2 days ago) - :newspaper: RSS/Atom feed reader
- [nextcloud/guests](https://github.com/nextcloud/guests) ([v1.6.1](https://github.com/nextcloud/guests/releases/tag/v1.6.1), 4 days ago) - 🙈 Create guest users which can only see files shared with them
- [nextcloud/server](https://github.com/nextcloud/server) ([v20.0.1](https://github.com/nextcloud/server/releases/tag/v20.0.1), 4 days ago) - ☁️ Nextcloud server, a safe home for all your data
- [laravel/homestead](https://github.com/laravel/homestead) ([v11.3.0](https://github.com/laravel/homestead/releases/tag/v11.3.0), 5 days ago) - 
- [nextcloud/spreed](https://github.com/nextcloud/spreed) ([v10.0.1](https://github.com/nextcloud/spreed/releases/tag/v10.0.1), 5 days ago) - 📞😀 Nextcloud Talk – chat, video &amp; audio calls for Nextcloud
