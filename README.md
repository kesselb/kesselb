...
- [nextcloud/updater](https://github.com/nextcloud/updater) - :arrows_counterclockwise: The updater app to keep your Nextcloud up-to-date (4 days ago)
...
- [horde/ManageSieve](https://github.com/horde/ManageSieve) - Client library for ManageSieve (4 weeks ago)
...
- [icewind1991/SMB](https://github.com/icewind1991/SMB) ([v3.3.0](https://github.com/icewind1991/SMB/releases/tag/v3.3.0), today) - PHP wrapper for smbclient
- [nextcloud/mail](https://github.com/nextcloud/mail) ([v1.9.0-alpha3](https://github.com/nextcloud/mail/releases/tag/v1.9.0-alpha3), 1 day ago) - 💌 Mail app for Nextcloud
- [nextcloud/groupfolders](https://github.com/nextcloud/groupfolders) ([v9.0.0](https://github.com/nextcloud/groupfolders/releases/tag/v9.0.0), 4 days ago) - 📁👩‍👩‍👧‍👦 Admin-configured folders shared by everyone in a group.
...
- [nextcloud/android](https://github.com/nextcloud/android) ([rc-3.15.1-01](https://github.com/nextcloud/android/releases/tag/rc-3.15.1-01), 6 days ago) - 📱 Nextcloud Android app
- [nextcloud/android-library](https://github.com/nextcloud/android-library) ([rc-2.5.1-01](https://github.com/nextcloud/android-library/releases/tag/rc-2.5.1-01), 6 days ago) - ☎️ Nextcloud Android library
...
- [nextcloud/guests](https://github.com/nextcloud/guests) ([v1.5.1](https://github.com/nextcloud/guests/releases/tag/v1.5.1), 4 weeks ago) - 🙈 Create guest users which can only see files shared with them
