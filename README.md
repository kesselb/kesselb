...
- [ChristophWurst/setup-nextcloud](https://github.com/ChristophWurst/setup-nextcloud) - Github action to set up a Nextcloud environment for CI (1 week ago)
...
- [maennchen/ZipStream-PHP](https://github.com/maennchen/ZipStream-PHP) - :floppy_disk: PHP ZIP Streaming Library (2 weeks ago)
...
- [nextcloud-libraries/nextcloud-vue](https://github.com/nextcloud-libraries/nextcloud-vue) ([v8.0.0-beta.4](https://github.com/nextcloud-libraries/nextcloud-vue/releases/tag/v8.0.0-beta.4), 2 days ago) - 🍱 Vue.js components for Nextcloud app development ✌ https://npmjs.org/@nextcloud/vue
- [wp-media/wp-rocket](https://github.com/wp-media/wp-rocket) ([v3.15-alpha1](https://github.com/wp-media/wp-rocket/releases/tag/v3.15-alpha1), 3 days ago) - Performance optimization plugin for WordPress
- [nextcloud/helm](https://github.com/nextcloud/helm) ([nextcloud-4.1.0](https://github.com/nextcloud/helm/releases/tag/nextcloud-4.1.0), 4 days ago) - A helm chart for deploying nextcloud on Kubernetes
- [sabre-io/http](https://github.com/sabre-io/http) ([5.1.10](https://github.com/sabre-io/http/releases/tag/5.1.10), 1 week ago) - The sabre/http library provides utilities for dealing with http requests and responses.
- [nextcloud-releases/calendar](https://github.com/nextcloud-releases/calendar) ([v4.5.0-beta2](https://github.com/nextcloud-releases/calendar/releases/tag/v4.5.0-beta2), 1 week ago) - 
