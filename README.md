...
- [nextcloud/text](https://github.com/nextcloud/text) - 📑 Collaborative document editing using Markdown (2 days ago)
...
- [alexdebril/feed-io](https://github.com/alexdebril/feed-io) ([v4.7.9](https://github.com/alexdebril/feed-io/releases/tag/v4.7.9), 2 days ago) - A PHP library to read and write feeds in JSONFeed, RSS or Atom format
- [nextcloud/spreed](https://github.com/nextcloud/spreed) ([v10.0.0-rc.1](https://github.com/nextcloud/spreed/releases/tag/v10.0.0-rc.1), 6 days ago) - 📞😀 Nextcloud Talk – chat, video &amp; audio calls for Nextcloud
