...
- [nextcloud/android-library](https://github.com/nextcloud/android-library) ([rc-2.4.2-02](https://github.com/nextcloud/android-library/releases/tag/rc-2.4.2-02), today) - ☎️ Nextcloud Android library
- [nextcloud/guests](https://github.com/nextcloud/guests) ([v1.6.2](https://github.com/nextcloud/guests/releases/tag/v1.6.2), 1 day ago) - 🙈 Create guest users which can only see files shared with them
- [nextcloud/news](https://github.com/nextcloud/news) ([15.1.1-rc1](https://github.com/nextcloud/news/releases/tag/15.1.1-rc1), 6 days ago) - :newspaper: RSS/Atom feed reader
- [nextcloud/server](https://github.com/nextcloud/server) ([v20.0.4](https://github.com/nextcloud/server/releases/tag/v20.0.4), 6 days ago) - ☁️ Nextcloud server, a safe home for all your data
- [jhass/nextcloud-keeweb](https://github.com/jhass/nextcloud-keeweb) ([v0.6.4](https://github.com/jhass/nextcloud-keeweb/releases/tag/v0.6.4), 1 week ago) - Integrate Keeweb into Nextcloud
...
- [strukturag/nextcloud-spreed-signaling](https://github.com/strukturag/nextcloud-spreed-signaling) ([v0.2.0](https://github.com/strukturag/nextcloud-spreed-signaling/releases/tag/v0.2.0), 2 weeks ago) - Standalone signaling server for Nextcloud Talk.
...
- [laravel/homestead](https://github.com/laravel/homestead) ([v10.17.0](https://github.com/laravel/homestead/releases/tag/v10.17.0), 3 weeks ago) - 
