...
- [nextcloud/guests](https://github.com/nextcloud/guests) - 🙈 Create guest users which can only see files shared with them (3 days ago)
...
- [laravel/homestead](https://github.com/laravel/homestead) ([v11.2.2](https://github.com/laravel/homestead/releases/tag/v11.2.2), today) - 
...
- [nextcloud/android-library](https://github.com/nextcloud/android-library) ([rc-2.3.1-01](https://github.com/nextcloud/android-library/releases/tag/rc-2.3.1-01), 6 days ago) - ☎️ Nextcloud Android library
