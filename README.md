...
- [nextcloud/news](https://github.com/nextcloud/news) ([15.1.1-rc1](https://github.com/nextcloud/news/releases/tag/15.1.1-rc1), 1 day ago) - :newspaper: RSS/Atom feed reader
- [nextcloud/server](https://github.com/nextcloud/server) ([v20.0.4](https://github.com/nextcloud/server/releases/tag/v20.0.4), 1 day ago) - ☁️ Nextcloud server, a safe home for all your data
- [nextcloud/desktop](https://github.com/nextcloud/desktop) ([v3.1.0](https://github.com/nextcloud/desktop/releases/tag/v3.1.0), 3 days ago) - 💻 Desktop sync client for Nextcloud
- [jhass/nextcloud-keeweb](https://github.com/jhass/nextcloud-keeweb) ([v0.6.4](https://github.com/jhass/nextcloud-keeweb/releases/tag/v0.6.4), 4 days ago) - Integrate Keeweb into Nextcloud
- [alexdebril/feed-io](https://github.com/alexdebril/feed-io) ([v4.7.12](https://github.com/alexdebril/feed-io/releases/tag/v4.7.12), 6 days ago) - A PHP library to read and write feeds in JSONFeed, RSS or Atom format
