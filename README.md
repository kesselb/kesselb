...
- [nextcloud/android](https://github.com/nextcloud/android) ([stable-3.16.0](https://github.com/nextcloud/android/releases/tag/stable-3.16.0), 6 days ago) - 📱 Nextcloud Android app
...
- [nextcloud/guests](https://github.com/nextcloud/guests) ([v2.0.0](https://github.com/nextcloud/guests/releases/tag/v2.0.0), 4 weeks ago) - 🙈 Create guest users which can only see files shared with them
