...
- [nextcloud/desktop](https://github.com/nextcloud/desktop) ([v3.1.0-rc1](https://github.com/nextcloud/desktop/releases/tag/v3.1.0-rc1), 2 days ago) - 💻 Desktop sync client for Nextcloud
- [nextcloud/news](https://github.com/nextcloud/news) ([15.1.0-rc3](https://github.com/nextcloud/news/releases/tag/15.1.0-rc3), 4 days ago) - :newspaper: RSS/Atom feed reader
- [nextcloud/android](https://github.com/nextcloud/android) ([rc-3.14.0-02](https://github.com/nextcloud/android/releases/tag/rc-3.14.0-02), 5 days ago) - 📱 Nextcloud Android app
- [nextcloud/groupfolders](https://github.com/nextcloud/groupfolders) ([v6.0.9](https://github.com/nextcloud/groupfolders/releases/tag/v6.0.9), 6 days ago) - 📁👩‍👩‍👧‍👦 Admin-configured folders shared by everyone in a group.
...
- [nextcloud/server](https://github.com/nextcloud/server) ([v20.0.1](https://github.com/nextcloud/server/releases/tag/v20.0.1), 3 weeks ago) - ☁️ Nextcloud server, a safe home for all your data
